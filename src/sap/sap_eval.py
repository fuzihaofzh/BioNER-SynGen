...
def parse_args():
    ...
    parser.add_argument('--cometa_user', action="store_true")
...
def load_queries_COMETA_user(data_dir, load_full_sentence, filter_duplicate):
    dataset = QueryDataset_COMETA_user(
        data_dir=data_dir,
        load_full_sentence=load_full_sentence,
        filter_duplicate=filter_duplicate
    )
...
def main(args):
    ...
    elif args.cometa_user:
        print ("[loading My COMETA results queries...]")
        eval_queries = load_queries_COMETA_user(       
            data_dir=args.data_dir,
            load_full_sentence=False,
            filter_duplicate=args.filter_duplicate
            )
        print ("[COMETA user queries loaded]")
